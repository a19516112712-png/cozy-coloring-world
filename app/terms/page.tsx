  ...
  return (
    <div className="page-container py-12 sm:py-16 max-w-3xl">
      <nav className="mb-8 text-sm" aria-label="Breadcrumb">
        ...
        <span className="text-cocoa/60">Terms of Use</span>
      </nav>
      ...
      <div className="prose prose-cocoa max-w-none space-y-4 text-cocoa/80 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-cocoa mt-8">8. Changes to Terms</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-cocoa mt-8">9. Contact</h2>
        <p>
