...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/blog-covers/cottagecore-coloring-pages.webp",
  imageWidth: 1200,
  imageHeight: 1500,
  ...
  path: "/blog/cottagecore-coloring-pages",
});

export default function BlogPost() {
  const title = "Cottagecore Coloring Pages: Free Printable Cozy Cottage Scenes";
...
const blogSchema = {
  ...
  "@type": "Article",
  "headline": "Cottagecore Coloring Pages: Free Printable Cozy Cottage Scenes",
  "description": "Escape to the countryside with our cottagecore coloring pages. Charming cottages, flower gardens, and pastoral scenes.",
  "url": "https://tinyanimalworlds.com/blog/cottagecore-coloring-pages",
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Cottagecore Coloring Pages: Free Printable Cozy Cottage Scenes", url: "https://tinyanimalworlds.com/blog/cottagecore-coloring-pages" }
]);
  return (<>
    <script
    ...
    <article className="page-container py-12 sm:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Escape to the countryside with our cottagecore coloring pages. Charming cottages, flower gardens, and pastoral scenes.</p>
          ...
          <section className="mb-10">
            ...
            <RelatedArticles
              categoryId="cottagecore-coloring"
              type="coloring"
              count={6}
          ...
          <section className="mb-10">
            ...
            <RelatedArticles
              currentSlug="cottagecore-coloring-pages"
              type="article"
              count={3}
