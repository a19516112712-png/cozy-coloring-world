  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
          ...
          <ul className="space-y-2 mb-6"><li><Link href="/word-search/fox-classroom-word-search" className="text-rose hover:underline">Fox Classroom Word Search</Link></li>
            <li><Link href="/word-search/bear-classroom-word-search" className="text-rose hover:underline">Bear Classroom Word Search</Link></li>
            <li><Link href="/word-search/owl-classroom-word-search" className="text-rose hover:underline">Owl Classroom Word Search</Link></li>
            <li><Link href="/word-search/cat-classroom-word-search" className="text-rose hover:underline">Cat Classroom Word Search</Link></li>
            <li><Link href="/word-search/bunny-classroom-word-search" className="text-rose hover:underline">Bunny Classroom Word Search</Link></li></ul>
