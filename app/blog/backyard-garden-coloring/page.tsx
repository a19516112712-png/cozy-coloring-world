...
export default function BlogPost() {
  const faqs = [{"q":"What garden scenes are included?","a":"Our backyard garden collection features garden trellises, flower swings, herb corners, bird baths, butterfly gardens, lemon tree corners, garden fountains, and lantern evenings. Every page celebrates the beauty of outdoor garden spaces."},{"q":"Are these suitable for garden lovers?","a":"Absolutely! Garden enthusiasts will love coloring detailed flower arrangements, cozy garden nooks, and peaceful backyard retreats. These pages are perfect for nature lovers and gardening fans."},{"q":"How many garden pages are there?","a":"We have over 30 unique backyard and garden coloring pages, each capturing a different peaceful garden moment or cozy outdoor corner."}];
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(blogSchema) }} />
      <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-cocoa leading-tight mb-3">Backyard and Garden Retreat Coloring Pages</h1>
          ...
          <div className="prose prose-cocoa max-w-none"><p className="text-lg text-cocoa/70 leading-relaxed mb-6">Find peace in the garden with backyard and garden coloring pages! Flower swings, herb corners, garden fountains, butterfly gardens, and sunset gatherings. Free printable JPG downloads.</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                <Link href="/coloring/cozy-summer-garden-trellis" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌿</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Garden Trellis</span></div></Link>
                <Link href="/coloring/cozy-backyard-flower-swing" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌸</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Flower Swing</span></div></Link>
                <Link href="/coloring/cozy-garden-bird-bath" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🐦</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Bird Bath</span></div></Link>
                <Link href="/coloring/cozy-summer-butterfly-garden" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🦋</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Butterfly Garden</span></div></Link>
                <Link href="/coloring/cozy-garden-herb-corner" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌱</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Herb Corner</span></div></Link>
                <Link href="/coloring/cozy-garden-fountain-afternoon" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">⛲</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Garden Fountain</span></div></Link>
            </div>
          ...
          <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="backyard-garden-coloring" type="article" count={3} title="More Articles to Explore" /></section>
