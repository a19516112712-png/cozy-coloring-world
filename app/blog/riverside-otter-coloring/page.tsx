      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          ...
          <p className="text-cocoa/75 leading-relaxed mb-4">
            Ready to start coloring? Download these free printable pages from our collection — no sign-up required! Browse more in our <Link href="/categories/cozy-coloring" className="text-rose hover:underline">category</Link> <Link href="/categories/cute-animals" className="text-rose hover:underline">category</Link> <Link href="/categories/cottagecore-coloring" className="text-rose hover:underline">category</Link> <Link href="/categories/rainy-day-coloring" className="text-rose hover:underline">category</Link> sections.
          </p>
