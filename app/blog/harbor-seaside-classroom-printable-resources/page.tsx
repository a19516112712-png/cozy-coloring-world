...
export const metadata: Metadata = generatePageMetadata({ title: "Harbor & Seaside Classroom Printables: Free Word Search Puzzles", description: "Download free harbor and seaside themed word search puzzles for your classroom. Lighthouses, docks, sailboats!", path: "/blog/harbor-seaside-classroom-printable-resources" });

export default function BlogPost() {
  const title = "Harbor & Seaside Classroom Printables: Free Wor..."; const date = "2026-06-13";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Harbor & Seaside Classroom Printables: Free Word Search Puzzles", "description": "Download free harbor and seaside themed word search puzzles for your classroom. Lighthouses, docks, sailboats!", "url": "https://tinyanimalworlds.com/blog/harbor-seaside-classroom-printable-resources", "datePublished": "2026-06-13", "dateModified": "2026-06-13", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.webp" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Harbor & Seaside Classroom Printables: Free Wor...", url: "https://tinyanimalworlds.com/blog/harbor-seaside-classroom-printable-resources" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Download free harbor and seaside themed word search puzzles for your classroom. Lighthouses, docks, sailboats! Our ever-growing collection now features 1400+ animal word search puzzles and 1700+ free printable coloring pages.</p>
          <h2 className="text-2xl font-bold text-cocoa mt-10 mb-4">Why Classroom Activities Matters</h2>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="harbor-seaside-classroom-printable-resources" type="article" count={3} title="More Articles" /></section>
