...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/blog/landmark-geography-printable-word-search-classroom",
});

export default function BlogPost() {
  const title = "Landmark Geography Printable Word Search: Classroom Activities That Teach World Wonders";
  const date = "2026-06-20";
  const blogSchema = {
    "@context": "https://schema.org", "@type": "Article",
    "headline": "Landmark Geography Printable Word Search: Classroom Activities That Teach World Wonders",
    "description": "Take kids on a world tour with printable geography word searches! Grand Canyon, Great Barrier Reef, Mount Everest — free puzzles that build geography vocabulary and global awareness.",
    "url": "https://tinyanimalworlds.com/blog/landmark-geography-printable-word-search-classroom",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Landmark Geography Printable Word Search: Classroom Activities That Teach World Wonders", url: "https://tinyanimalworlds.com/blog/landmark-geography-printable-word-search-classroom" }
  ]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Take kids on a world tour with printable geography word searches! Grand Canyon, Great Barrier Reef, Mount Everest — free puzzles that build geography vocabulary and global awareness.</p>
        ...
        <ul className="space-y-2 mb-6">
          <li><Link href="/word-search/cow-grand-canyon-word-search" className="text-rose hover:underline">Free Printable Cow Grand Canyon Word Search</Link></li>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">Beyond word searches, browse thousands of free printable resources: visit our <Link href="/word-search" className="text-rose hover:underline">Word Search Hub</Link> for 2,000+ puzzles, explore <Link href="/category/garden-coloring" className="text-rose hover:underline">Coloring Pages</Link> for creative fun, and check our <Link href="/blog" className="text-rose hover:underline">Blog</Link> for learning tips and activity ideas.</p>
      ...
      <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">Related Coloring Pages</h2><RelatedArticles categoryId="garden-coloring" type="coloring" count={6} title="Coloring Pages You Will Love" /></section>
      <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="landmark-geography-printable-word-search-classroom" type="article" count={3} title="More Articles to Explore" /></section>
      <Newsletter />
      <section className="mt-10 p-6 bg-cream rounded-xl border border-mocha/10"><h2 className="text-xl font-bold text-cocoa mb-2">About This Article</h2><p className="text-sm text-cocoa/50"><strong>Category:</strong> <Link href="/blog" className="text-rose hover:underline">Classroom Printables</Link> · <strong>Published:</strong> 2026-06-20 · <strong>Read Time:</strong> 8 min read · <strong>Tags:</strong> free printables, word search, kids activities, educational games, coloring pages, homeschool resources, classroom activities, vocabulary building, animal puzzles, printable worksheets</p></section>
