      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          ...
          <p className="text-cocoa/75 leading-relaxed mb-4">
            Ready to start coloring? Download these free printable pages from our collection — no sign-up required! Browse more in our <Link href="/category/cute-animals" className="text-rose hover:underline">category</Link> <Link href="/category/tiny-animal-worlds" className="text-rose hover:underline">category</Link> <Link href="/category/food-bakery" className="text-rose hover:underline">category</Link> <Link href="/category/garden-coloring" className="text-rose hover:underline">category</Link> sections.
          </p>
