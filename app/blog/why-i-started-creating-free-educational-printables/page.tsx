  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4"><strong>Lesson 3: Solve your own problem first.</strong> Every successful feature on this site started as something I personally needed. Coloring pages? My kids were bored. Word searches? My daughter wanted puzzles. <Link href="/category/cute-animals" className="text-rose hover:underline">Fox coloring</Link> and <Link href="/category/cute-animals" className="text-rose hover:underline">bunny coloring</Link> categories? Those are literally my kids' favorite animals. Building for yourself keeps you honest.</p>
