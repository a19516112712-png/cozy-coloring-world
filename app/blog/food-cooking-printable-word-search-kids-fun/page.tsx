...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/blog/food-cooking-printable-word-search-kids-fun",
});

export default function BlogPost() {
  const title = "Food and Cooking Printable Word Search: Delicious Kids Fun That Builds Vocabulary";
  const date = "2026-06-20";
  const blogSchema = {
    "@context": "https://schema.org", "@type": "Article",
    "headline": "Food and Cooking Printable Word Search: Delicious Kids Fun That Builds Vocabulary",
    "description": "Whet young appetites for learning with food-themed printable word searches! Pasta night, bread baking, smoothie shops — free puzzles that make cooking vocabulary and healthy eating fun.",
    "url": "https://tinyanimalworlds.com/blog/food-cooking-printable-word-search-kids-fun",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Food and Cooking Printable Word Search: Delicious Kids Fun That Builds Vocabulary", url: "https://tinyanimalworlds.com/blog/food-cooking-printable-word-search-kids-fun" }
  ]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Whet young appetites for learning with food-themed printable word searches! Pasta night, bread baking, smoothie shops — free puzzles that make cooking vocabulary and healthy eating fun.</p>
        ...
        <ul className="space-y-2 mb-6">
          <li><Link href="/word-search/caterpillar-pasta-night-word-search" className="text-rose hover:underline">Free Printable Cat Pasta Night Word Search</Link></li>
          <li><Link href="/word-search/snail-bread-baking-word-search" className="text-rose hover:underline">Free Printable Dog Bread Baking Word Search</Link></li>
          <li><Link href="/word-search/deer-soup-kitchen-word-search" className="text-rose hover:underline">Free Printable Owl Soup Kitchen Word Search</Link></li>
          <li><Link href="/word-search/hedgehog-salad-bar-word-search" className="text-rose hover:underline">Free Printable Penguin Salad Bar Word Search</Link></li>
          <li><Link href="/word-search/starfish-smoothie-shop-word-search" className="text-rose hover:underline">Free Printable Koala Smoothie Shop Word Search</Link></li>
        </ul>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">Beyond word searches, browse thousands of free printable resources: visit our <Link href="/word-search" className="text-rose hover:underline">Word Search Hub</Link> for 2,000+ puzzles, explore <Link href="/category/food-bakery" className="text-rose hover:underline">Coloring Pages</Link> for creative fun, and check our <Link href="/blog" className="text-rose hover:underline">Blog</Link> for learning tips and activity ideas.</p>
      ...
      <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="food-cooking-printable-word-search-kids-fun" type="article" count={3} title="More Articles to Explore" /></section>
      <Newsletter />
      <section className="mt-10 p-6 bg-cream rounded-xl border border-mocha/10"><h2 className="text-xl font-bold text-cocoa mb-2">About This Article</h2><p className="text-sm text-cocoa/50"><strong>Category:</strong> <Link href="/blog" className="text-rose hover:underline">Educational Games</Link> · <strong>Published:</strong> 2026-06-20 · <strong>Read Time:</strong> 7 min read · <strong>Tags:</strong> free printables, word search, kids activities, educational games, coloring pages, homeschool resources, classroom activities, vocabulary building, animal puzzles, printable worksheets</p></section>
