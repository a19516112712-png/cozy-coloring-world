...
export const metadata: Metadata = generatePageMetadata({
  ...
  imageWidth: 1200,
  imageHeight: 1500, title: "Cliff & Canyon Geography Printables: Free Word Search for Kids", description: "Learn geography with cliff and canyon themed free printable word search puzzles. Falcons, ledges, gorges!", path: "/blog/cliff-canyon-geography-printable-kids-puzzles" });
