...
export const metadata: Metadata = generatePageMetadata({ title: "Cliff & Canyon Geography Printables: Free Word Search for Kids", description: "Learn geography with cliff and canyon themed free printable word search puzzles. Falcons, ledges, gorges!", path: "/blog/cliff-canyon-geography-printable-kids-puzzles" });

export default function BlogPost() {
  const title = "Cliff & Canyon Geography Printables: Free Word ..."; const date = "2026-06-13";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Cliff & Canyon Geography Printables: Free Word Search for Kids", "description": "Learn geography with cliff and canyon themed free printable word search puzzles. Falcons, ledges, gorges!", "url": "https://tinyanimalworlds.com/blog/cliff-canyon-geography-printable-kids-puzzles", "datePublished": "2026-06-13", "dateModified": "2026-06-13", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.webp" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Cliff & Canyon Geography Printables: Free Word ...", url: "https://tinyanimalworlds.com/blog/cliff-canyon-geography-printable-kids-puzzles" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Learn geography with cliff and canyon themed free printable word search puzzles. Falcons, ledges, gorges! Our ever-growing collection now features 1400+ animal word search puzzles and 1700+ free printable coloring pages.</p>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="cliff-canyon-geography-printable-kids-puzzles" type="article" count={3} title="More Articles" /></section>
