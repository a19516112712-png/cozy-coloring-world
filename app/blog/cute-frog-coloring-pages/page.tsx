...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/blog-covers/cute-frog-coloring-pages.webp",
  imageWidth: 1200,
  imageHeight: 1500,
  ...
  path: "/blog/cute-frog-coloring-pages",
});

export default function BlogPost() {
  const title = "Cute Frog Coloring Pages: Free Printable Adorable Frog Scenes";
...
const blogSchema = {
  ...
  "@type": "Article",
  "headline": "Cute Frog Coloring Pages: Free Printable Adorable Frog Scenes",
  "description": "Hop into fun with our cute frog coloring pages! Frogs in bakeries, by ponds, in mushroom villages.",
  "url": "https://tinyanimalworlds.com/blog/cute-frog-coloring-pages",
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Cute Frog Coloring Pages: Free Printable Adorable Frog Scenes", url: "https://tinyanimalworlds.com/blog/cute-frog-coloring-pages" }
]);
  return (<>
    <script
    ...
    <article className="page-container py-12 sm:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Hop into fun with our cute frog coloring pages! Frogs in bakeries, by ponds, in mushroom villages.</p>
          ...
          <section className="mb-10">
            ...
            <RelatedArticles
              currentSlug="cute-frog-coloring-pages"
              type="article"
              count={3}
