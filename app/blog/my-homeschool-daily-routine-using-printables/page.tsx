  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">What actually worked during Year 1 wasn't the curriculum. It was the coloring pages I printed as 'breaks' between lessons. While my child colored <Link href="/coloring-pages" className="text-rose hover:underline">bunny picnic scenes</Link> or <Link href="/coloring-pages" className="text-rose hover:underline">cat bakery pages</Link>, I could catch my breath and reset. These 15-minute coloring breaks became the only reliable part of our day. Looking back, that was a clue I should have noticed much sooner.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4"><strong>11:15 AM — Wrap-Up + Free Choice:</strong> 15 minutes. We review what we learned. Then kids choose a final activity — usually another <Link href="/word-search/fox-nature-outdoors-word-search" className="text-rose hover:underline">word search</Link> or <Link href="/coloring-pages" className="text-rose hover:underline">coloring page</Link> while I prep lunch.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4"><strong>Choice is a learning accelerator.</strong> When my child chooses between a <Link href="/word-search/bunny-garden-friends-word-search" className="text-rose hover:underline">bunny word search</Link> and a <Link href="/coloring-pages" className="text-rose hover:underline">bunny coloring page</Link>, engagement is higher than when I assign one. The educational content is similar either way — the autonomy makes the difference.</p>
