  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">Coloring days use <Link href="/categories/cute-animals" className="text-rose hover:underline">cute animal pages</Link> with moderate detail &mdash; <Link href="/coloring/5_Cute_bunny_picnic_meadow_color" className="text-rose hover:underline">bunny picnic scenes</Link>, <Link href="/coloring/8_Cute_cat_cupcake_bakery_colori" className="text-rose hover:underline">cat bakery pages</Link>, <Link href="/coloring/28_Cute_bunny_cottage_coloring_pa" className="text-rose hover:underline">cottage scenes</Link>. I avoid anything that looks &quot;babyish&quot; for fourth graders &mdash; the cottagecore and tiny animal village aesthetic works across a wide age range. These are from free online collections like <Link href="/categories" className="text-rose hover:underline">Tiny Animal Worlds</Link>.</p>
