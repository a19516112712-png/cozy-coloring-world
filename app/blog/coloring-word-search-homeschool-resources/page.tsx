...
export const metadata: Metadata = generatePageMetadata({ title: "Coloring Pages & Word Search: Ultimate Homeschool Resources Bundle", description: "Combine free printable coloring pages and word search puzzles for a complete homeschool curriculum. Perfect for multi-age learning at home.", path: "/blog/coloring-word-search-homeschool-resources" });

export default function BlogPost() {
  const title = "Coloring Pages & Word Search: Ultimate Homescho..."; const date = "2026-06-11";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Coloring Pages & Word Search: Ultimate Homeschool Resources Bundle", "description": "Combine free printable coloring pages and word search puzzles for a complete homeschool curriculum. Perfect for multi-age learning at home.", "url": "https://tinyanimalworlds.com/blog/coloring-word-search-homeschool-resources", "datePublished": "2026-06-11", "dateModified": "2026-06-11", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.png" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Coloring Pages & Word Search: Ultimate Homescho...", url: "https://tinyanimalworlds.com/blog/coloring-word-search-homeschool-resources" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <p className="text-sm text-cocoa/40 mb-8">Published {date} &middot; 7 min read &middot; <Link href="/categories" className="text-rose hover:underline">Homeschool Resources</Link></p>
      <AdBanner slot="blog-top" className="mb-8" />
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Combine free printable coloring pages and word search puzzles for a complete homeschool curriculum. Perfect for multi-age learning at home. Our ever-growing collection now features 1200+ animal word search puzzles and 1600+ free printable coloring pages — all ready to download and print instantly.</p>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="coloring-word-search-homeschool-resources" type="article" count={3} title="More Articles" /></section>
