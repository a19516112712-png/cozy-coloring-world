...
export const metadata: Metadata = generatePageMetadata({ title: "Thicket & Woodland Homeschool Bundle: Free Printable Word Search", description: "Complete thicket and woodland homeschool bundle with free printable word search puzzles. Brambles, wrens, hedges!", path: "/blog/thicket-woodland-homeschool-printable-bundle" });

export default function BlogPost() {
  const title = "Thicket & Woodland Homeschool Bundle: Free Prin..."; const date = "2026-06-13";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Thicket & Woodland Homeschool Bundle: Free Printable Word Search", "description": "Complete thicket and woodland homeschool bundle with free printable word search puzzles. Brambles, wrens, hedges!", "url": "https://tinyanimalworlds.com/blog/thicket-woodland-homeschool-printable-bundle", "datePublished": "2026-06-13", "dateModified": "2026-06-13", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.webp" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Thicket & Woodland Homeschool Bundle: Free Prin...", url: "https://tinyanimalworlds.com/blog/thicket-woodland-homeschool-printable-bundle" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Complete thicket and woodland homeschool bundle with free printable word search puzzles. Brambles, wrens, hedges! Our ever-growing collection now features 1400+ animal word search puzzles and 1700+ free printable coloring pages.</p>
          <h2 className="text-2xl font-bold text-cocoa mt-10 mb-4">Why Homeschool Resources Matters</h2>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="thicket-woodland-homeschool-printable-bundle" type="article" count={3} title="More Articles" /></section>
