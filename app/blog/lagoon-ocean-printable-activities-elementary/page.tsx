...
export const metadata: Metadata = generatePageMetadata({ title: "Lagoon & Ocean Printable Activities: Free Word Search for Elementary Kids", description: "Dive into lagoon and ocean learning with free printable word search puzzles. Coral reefs, mangroves, stingrays!", path: "/blog/lagoon-ocean-printable-activities-elementary" });
