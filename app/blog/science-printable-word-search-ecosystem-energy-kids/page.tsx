...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/blog/science-printable-word-search-ecosystem-energy-kids",
});

export default function BlogPost() {
  const title = "Science Printable Word Search: Ecosystem, Energy, and Earth Science Vocabulary for Kids";
  const date = "2026-06-20";
  const blogSchema = {
    "@context": "https://schema.org", "@type": "Article",
    "headline": "Science Printable Word Search: Ecosystem, Energy, and Earth Science Vocabulary for Kids",
    "description": "Spark scientific curiosity with printable science word searches! Covering ecosystems, energy sources, carbon cycles, and ocean exploration — free STEM puzzles for budding scientists ages 6-12.",
    "url": "https://tinyanimalworlds.com/blog/science-printable-word-search-ecosystem-energy-kids",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Science Printable Word Search: Ecosystem, Energy, and Earth Science Vocabulary for Kids", url: "https://tinyanimalworlds.com/blog/science-printable-word-search-ecosystem-energy-kids" }
  ]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Spark scientific curiosity with printable science word searches! Covering ecosystems, energy sources, carbon cycles, and ocean exploration — free STEM puzzles for budding scientists ages 6-12.</p>
      ...
      <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="science-printable-word-search-ecosystem-energy-kids" type="article" count={3} title="More Articles to Explore" /></section>
      <Newsletter />
      <section className="mt-10 p-6 bg-cream rounded-xl border border-mocha/10"><h2 className="text-xl font-bold text-cocoa mb-2">About This Article</h2><p className="text-sm text-cocoa/50"><strong>Category:</strong> <Link href="/blog" className="text-rose hover:underline">STEM Activities</Link> · <strong>Published:</strong> 2026-06-20 · <strong>Read Time:</strong> 9 min read · <strong>Tags:</strong> free printables, word search, kids activities, educational games, coloring pages, homeschool resources, classroom activities, vocabulary building, animal puzzles, printable worksheets</p></section>
