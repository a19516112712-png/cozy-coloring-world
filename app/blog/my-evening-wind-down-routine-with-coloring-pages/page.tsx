  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">The next night, I printed my own page — a <Link href="/coloring-pages" className="text-rose hover:underline">bunny picnic scene</Link> that I&apos;d originally created for my daughter. By the end of the week, I had a small stack of completed coloring pages and a noticeably better mood. My husband commented that I seemed &quot;less frazzled&quot; at breakfast, which is married-people code for &quot;you&apos;re not snapping at everyone anymore.&quot;</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4"><strong>No decision fatigue.</strong> When I open Netflix, I face an overwhelming grid of choices. When I pull out a <Link href="/coloring-pages" className="text-rose hover:underline">coloring page</Link> I&apos;ve already printed, there&apos;s exactly one thing to do: pick up a pencil and start. My tired brain doesn&apos;t have to decide anything.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4"><strong>8:45 PM:</strong> I take out my colored pencil tin and the page I selected earlier in the day. I keep a small stack of printed coloring pages in a kitchen drawer — right now it includes <Link href="/coloring-pages" className="text-rose hover:underline">frog mushroom village</Link>, <Link href="/coloring-pages" className="text-rose hover:underline">cat cupcake bakery</Link>, and <Link href="/coloring-pages" className="text-rose hover:underline">penguin winter wonderland</Link>. I pick one based on my mood — detailed pages when I want to focus, simpler ones when I&apos;m truly exhausted.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">I print from <Link href="/categories" className="text-rose hover:underline">our own collection</Link> — over 2,000 free coloring pages across dozens of themes. I browse <Link href="/category/cute-animals" className="text-rose hover:underline">cute animals</Link> and <Link href="/category/cottagecore-coloring" className="text-rose hover:underline">cottagecore</Link> categories when I want something cozy. Everything is free to download and print.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">I used to think so. Then I tried it. Now I think judging harmless activities that make people feel better is the actually childish behavior. The adult coloring book market exists for a reason. If coloring <Link href="/coloring-pages" className="text-rose hover:underline">bunny cottage scenes</Link> for 20 minutes makes me a calmer, more patient parent the next morning, I&apos;ll color bunnies without a shred of embarrassment.</p>
