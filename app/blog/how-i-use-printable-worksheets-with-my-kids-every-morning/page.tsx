  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4"><strong>Coloring pages</strong> are our anchor. Three mornings a week, both kids get coloring pages. I choose pages based on difficulty — easy pages with fewer details for my kindergartener, more intricate scenes for my second grader. Our current favorites are the <Link href="/coloring/5_Cute_bunny_picnic_meadow_color" className="text-rose hover:underline">bunny picnic meadow</Link> and <Link href="/coloring/8_Cute_cat_cupcake_bakery_colori" className="text-rose hover:underline">cat cupcake bakery</Link> pages. The cottagecore and tiny animal themes keep them interested far longer than generic coloring books ever did.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">I also keep a small stack of <Link href="/category/fox-coloring" className="text-rose hover:underline">extra coloring pages</Link> and <Link href="/category/bunny-coloring" className="text-rose hover:underline">seasonal printables</Link> in a drawer for days when we need variety. The key is having everything ready to go — decision fatigue in the morning kills routines.</p>
