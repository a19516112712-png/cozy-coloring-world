...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/coloring/18_hedgehog_greenhouse_interior.webp",
  imageWidth: 1200,
  imageHeight: 1500, title: "Greenhouse and Indoor Plant Coloring Pages: Free Printable JPG Downloads", description: "Step into a cozy greenhouse with plant-themed coloring pages! Greenhouse interiors, potted plants, herb corners, flower arrangements, and botanical garden scenes. Free printable JPG downloads.", path: "/blog/greenhouse-plant-coloring-pages" });

const blogSchema = { "@context": "https://schema.org", "@type": "BlogPosting", headline: "Greenhouse and Indoor Plant Coloring Pages: Free Printable JPG Downloads", description: "Step into a cozy greenhouse with plant-themed coloring pages! Greenhouse interiors, potted plants, herb corners, flower arrangements, and botanical garden scenes. Free printable JPG downloads.", datePublished: "2026-06-03", dateModified: "2026-06-03", author: { "@type": "Organization", name: "Tiny Animal Worlds" }, publisher: { "@type": "Organization", name: "Tiny Animal Worlds" }, keywords: "greenhouse coloring pages, indoor plant printable, botanical coloring, greenhouse garden pages, plant lover coloring" };

export default function BlogPost() {
  const faqs = [{"q":"What greenhouse scenes can I color?","a":"Our greenhouse collection features greenhouse interiors filled with plants, herb corners, flower arrangements, planting scenes, garden sheds, and botanical settings — all with cozy, inviting details."},{"q":"Are these good for plant lovers?","a":"Plant enthusiasts will love these detailed greenhouse and botanical scenes! Each page celebrates the beauty of indoor gardening, from tiny potted plants to lush greenhouse interiors."},{"q":"How many greenhouse pages are there?","a":"We have over 20 greenhouse and indoor plant coloring pages with new botanical scenes added regularly."}];
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(blogSchema) }} />
      <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-cocoa leading-tight mb-3">Greenhouse and Indoor Plant Coloring Pages</h1>
          <p className="text-sm text-cocoa/40 mb-8">Published 2026-06-03 - 8 min read</p>
          <AdBanner slot="blog-top" className="mb-8" />
          <div className="prose prose-cocoa max-w-none"><p className="text-lg text-cocoa/70 leading-relaxed mb-6">Step into a cozy greenhouse with plant-themed coloring pages! Greenhouse interiors, potted plants, herb corners, flower arrangements, and botanical garden scenes. Free printable JPG downloads.</p>
          <div className="my-6 p-4 bg-cream rounded-lg border border-mocha/10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                <Link href="/coloring/hedgehog-greenhouse-interior" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🦔</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Hedgehog Greenhouse</span></div></Link>
                <Link href="/coloring/hedgehog-garden-shed" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🏠</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Garden Shed</span></div></Link>
                <Link href="/coloring/hedgehog-greenhouse-garden" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌱</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Greenhouse Garden</span></div></Link>
                <Link href="/coloring/hedgehog-planting-herbs" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌿</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Planting Herbs</span></div></Link>
                <Link href="/coloring/cozy-summer-greenhouse-corner" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">☀️</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Summer Corner</span></div></Link>
                <Link href="/coloring/hedgehog-carrying-watering-can" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">💧</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Watering Can</span></div></Link>
            </div>
          ...
          <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="greenhouse-plant-coloring-pages" type="article" count={3} title="More Articles to Explore" /></section>
