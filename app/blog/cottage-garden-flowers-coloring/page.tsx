...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/coloring/13_deer_watering_vegetable_garden.webp",
  imageWidth: 1200,
  imageHeight: 1500, title: "Cottage Garden and Flower Coloring Pages: Free Printable JPG Downloads", description: "Stroll through blooming cottage gardens! Watering vegetable patches, flower carts, garden pathways, herb gardens, and sunflower meadows. Free printable JPG downloads for garden lovers.", path: "/blog/cottage-garden-flowers-coloring" });

const blogSchema = { "@context": "https://schema.org", "@type": "BlogPosting", headline: "Cottage Garden and Flower Coloring Pages: Free Printable JPG Downloads", description: "Stroll through blooming cottage gardens! Watering vegetable patches, flower carts, garden pathways, herb gardens, and sunflower meadows. Free printable JPG downloads for garden lovers.", datePublished: "2026-06-04", dateModified: "2026-06-04", author: { "@type": "Organization", name: "Tiny Animal Worlds" }, publisher: { "@type": "Organization", name: "Tiny Animal Worlds" }, keywords: "cottage garden coloring pages, flower garden printable, vegetable garden coloring, watering flowers pages, cottage garden flowers" };

export default function BlogPost() {
  const faqs = [{"q":"What garden scenes are featured?","a":"Our cottage garden collection includes watering vegetable gardens, flower carts, garden pathways, greenhouse gardens, watering flowers, and cottage garden scenes. Each page celebrates the joy of tending a beautiful cottage garden."},{"q":"Are these good for gardening enthusiasts?","a":"Gardeners will love these pages! They capture the peaceful beauty of cottage gardening — from watering vegetables to arranging flower carts. A perfect screen-free activity for plant lovers."},{"q":"How many cottage garden pages are there?","a":"We have over 20 cottage garden and flower coloring pages featuring charming deer characters tending their beautiful gardens."}];
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(blogSchema) }} />
      <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-cocoa leading-tight mb-3">Cottage Garden and Flower Coloring Pages</h1>
          <p className="text-sm text-cocoa/40 mb-8">Published 2026-06-04 - 8 min read</p>
          <AdBanner slot="blog-top" className="mb-8" />
          <div className="prose prose-cocoa max-w-none"><p className="text-lg text-cocoa/70 leading-relaxed mb-6">Stroll through blooming cottage gardens! Watering vegetable patches, flower carts, garden pathways, herb gardens, and sunflower meadows. Free printable JPG downloads for garden lovers.</p>
          <div className="my-6 p-4 bg-cream rounded-lg border border-mocha/10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                <Link href="/coloring/deer-watering-vegetable-garden" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🥕</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Vegetable Garden</span></div></Link>
                <Link href="/coloring/deer-flower-cart" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🛒</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Flower Cart</span></div></Link>
                ...
                <Link href="/coloring/deer-watering-flowers" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">💧</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Watering</span></div></Link>
                <Link href="/coloring/deer-cottage-garden" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌻</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Cottage Garden</span></div></Link>
                <Link href="/coloring/deer-flower-pathway" className="group bg-white rounded-xl border border-blush/20 p-3 hover:shadow-md transition-all hover:-translate-y-0.5"><div className="flex items-center gap-2"><span className="text-lg">🌿</span><span className="text-xs text-cocoa/70 group-hover:text-rose transition-colors line-clamp-2">Flower Path</span></div></Link>
            </div>
          ...
          <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">Related Coloring Pages</h2><RelatedArticles categoryId="garden-coloring" type="coloring" count={6} title="Coloring Pages Youll Love" /></section>
          <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="cottage-garden-flowers-coloring" type="article" count={3} title="More Articles to Explore" /></section>
