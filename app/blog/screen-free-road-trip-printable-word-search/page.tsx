...
export const metadata: Metadata = generatePageMetadata({
  ...
  imageWidth: 1200,
  imageHeight: 1500, title: "Screen-Free Road Trip Fun: Free Printable Word Search Puzzles for Kids", description: "Keep kids entertained on long car rides with screen-free printable word search puzzles. Perfect travel activities that make learning fun on the go.", path: "/blog/screen-free-road-trip-printable-word-search" });

export default function BlogPost() {
  const title = "Screen-Free Road Trip Fun: Free Printable Word ..."; const date = "2026-06-11";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Screen-Free Road Trip Fun: Free Printable Word Search Puzzles for Kids", "description": "Keep kids entertained on long car rides with screen-free printable word search puzzles. Perfect travel activities that make learning fun on the go.", "url": "https://tinyanimalworlds.com/blog/screen-free-road-trip-printable-word-search", "datePublished": "2026-06-11", "dateModified": "2026-06-11", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.webp" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Screen-Free Road Trip Fun: Free Printable Word ...", url: "https://tinyanimalworlds.com/blog/screen-free-road-trip-printable-word-search" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Keep kids entertained on long car rides with screen-free printable word search puzzles. Perfect travel activities that make learning fun on the go. Our ever-growing collection now features 1200+ animal word search puzzles and 1600+ free printable coloring pages — all ready to download and print instantly.</p>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="screen-free-road-trip-printable-word-search" type="article" count={3} title="More Articles" /></section>
