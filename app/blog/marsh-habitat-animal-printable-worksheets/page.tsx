...
export const metadata: Metadata = generatePageMetadata({ title: "Marsh Habitat Animal Printable Worksheets: Free Word Search Activities", description: "Explore marsh habitats with free printable animal word search worksheets. Cattails, dragonflies, egrets!", path: "/blog/marsh-habitat-animal-printable-worksheets" });

export default function BlogPost() {
  const title = "Marsh Habitat Animal Printable Worksheets: Free..."; const date = "2026-06-13";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Marsh Habitat Animal Printable Worksheets: Free Word Search Activities", "description": "Explore marsh habitats with free printable animal word search worksheets. Cattails, dragonflies, egrets!", "url": "https://tinyanimalworlds.com/blog/marsh-habitat-animal-printable-worksheets", "datePublished": "2026-06-13", "dateModified": "2026-06-13", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.webp" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Marsh Habitat Animal Printable Worksheets: Free...", url: "https://tinyanimalworlds.com/blog/marsh-habitat-animal-printable-worksheets" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Explore marsh habitats with free printable animal word search worksheets. Cattails, dragonflies, egrets! Our ever-growing collection now features 1400+ animal word search puzzles and 1700+ free printable coloring pages.</p>
          <h2 className="text-2xl font-bold text-cocoa mt-10 mb-4">Why Animal Learning Matters</h2>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="marsh-habitat-animal-printable-worksheets" type="article" count={3} title="More Articles" /></section>
