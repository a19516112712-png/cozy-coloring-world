...
export const metadata: Metadata = generatePageMetadata({ title: "Summer Learning Activities: Free Printable Word Search & Coloring Pages", description: "Prevent summer slide with fun printable word search puzzles and coloring pages. Keep kids engaged and learning all summer long with free activities.", path: "/blog/summer-learning-printable-word-search-coloring" });

export default function BlogPost() {
  const title = "Summer Learning Activities: Free Printable Word..."; const date = "2026-06-11";
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Summer Learning Activities: Free Printable Word Search & Coloring Pages", "description": "Prevent summer slide with fun printable word search puzzles and coloring pages. Keep kids engaged and learning all summer long with free activities.", "url": "https://tinyanimalworlds.com/blog/summer-learning-printable-word-search-coloring", "datePublished": "2026-06-11", "dateModified": "2026-06-11", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.png" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Summer Learning Activities: Free Printable Word...", url: "https://tinyanimalworlds.com/blog/summer-learning-printable-word-search-coloring" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <p className="text-sm text-cocoa/40 mb-8">Published {date} &middot; 7 min read &middot; <Link href="/categories" className="text-rose hover:underline">Kids Activities</Link></p>
      <AdBanner slot="blog-top" className="mb-8" />
      <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Prevent summer slide with fun printable word search puzzles and coloring pages. Keep kids engaged and learning all summer long with free activities. Our ever-growing collection now features 1200+ animal word search puzzles and 1600+ free printable coloring pages — all ready to download and print instantly.</p>
          <h2 className="text-2xl font-bold text-cocoa mt-10 mb-4">Why Kids Activities Matters for Kids</h2>
      ...
      <section className="mb-10"><RelatedArticles currentSlug="summer-learning-printable-word-search-coloring" type="article" count={3} title="More Articles" /></section>
