...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/blog-covers/bakery-coloring-pages.webp",
  imageWidth: 1200,
  imageHeight: 1500,
  ...
  path: "/blog/bakery-coloring-pages",
});

export default function BlogPost() {
  const title = "Bakery Coloring Pages: Free Printable Sweet Shop and Pastry Scenes";
...
const blogSchema = {
  ...
  "@type": "Article",
  "headline": "Bakery Coloring Pages: Free Printable Sweet Shop and Pastry Scenes",
  "description": "Treat yourself to our bakery coloring pages! Cupcake shops, bread bakeries, and sweet pastry scenes.",
  "url": "https://tinyanimalworlds.com/blog/bakery-coloring-pages",
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Bakery Coloring Pages: Free Printable Sweet Shop and Pastry Scenes", url: "https://tinyanimalworlds.com/blog/bakery-coloring-pages" }
]);
  return (<>
    <script
    ...
    <article className="page-container py-12 sm:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Treat yourself to our bakery coloring pages! Cupcake shops, bread bakeries, and sweet pastry scenes.</p>
          ...
          <section className="mb-10">
            ...
            <RelatedArticles
              currentSlug="bakery-coloring-pages"
              type="article"
              count={3}
