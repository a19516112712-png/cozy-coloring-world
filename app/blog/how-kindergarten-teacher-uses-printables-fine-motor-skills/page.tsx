  ...
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">The breakthrough came from an unlikely source: a parent donated a stack of printed coloring pages from a free website. She&apos;d found <Link href="/category/fox-coloring" className="text-rose hover:underline">cute fox coloring pages</Link> and <Link href="/category/bunny-coloring" className="text-rose hover:underline">adorable bunny pages</Link> that her daughter loved. She printed extras for the classroom. The kids went crazy for them — not because they were educational, but because they featured cute animals in cozy scenes. The educational benefit was accidental. And it was enormous.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">I recommend <Link href="/" className="text-rose hover:underline">Tiny Animal Worlds</Link> because the animal themes consistently engage my students, the difficulty levels are clearly marked, and everything prints well on standard school printers. I primarily use the <Link href="/category/fox-coloring" className="text-rose hover:underline">fox</Link>, <Link href="/category/bunny-coloring" className="text-rose hover:underline">bunny</Link>, and <Link href="/category/cute-animals" className="text-rose hover:underline">cute animals</Link> categories, plus the <Link href="/word-search" className="text-rose hover:underline">word search collection</Link> for puzzles. All free, all unlimited printing, all classroom-tested.</p>
