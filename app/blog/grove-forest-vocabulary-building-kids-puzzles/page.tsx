...
export default function BlogPost() {
  ...
  const bs = { "@context": "https://schema.org", "@type": "Article", "headline": "Grove & Forest Vocabulary Building: Free Printable Word Search Puzzles", "description": "Build vocabulary with grove and forest themed word search puzzles. Oaks, acorns, squirrels!", "url": "https://tinyanimalworlds.com/blog/grove-forest-vocabulary-building-kids-puzzles", "datePublished": "2026-06-13", "dateModified": "2026-06-13", "author": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com" }, "publisher": { "@type": "Organization", "name": "Tiny Animal Worlds", "url": "https://tinyanimalworlds.com", "logo": { "@type": "ImageObject", "url": "https://tinyanimalworlds.com/apple-touch-icon.webp" } } };
  const br = generateBreadcrumbSchema([{ name: "Home", url: "https://tinyanimalworlds.com" }, { name: "Blog", url: "https://tinyanimalworlds.com/blog" }, { name: "Grove & Forest Vocabulary Building: Free Printa...", url: "https://tinyanimalworlds.com/blog/grove-forest-vocabulary-building-kids-puzzles" }]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <section className="mb-10"><RelatedArticles currentSlug="grove-forest-vocabulary-building-kids-puzzles" type="article" count={3} title="More Articles" /></section>
