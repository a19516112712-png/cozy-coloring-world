...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/blog-covers/cozy-coloring-pages.webp",
  imageWidth: 1200,
  imageHeight: 1500,
    ...
    <article className="page-container py-12 sm:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">The ultimate collection of cozy coloring pages! From reading nooks to rainy windows, find your perfect relaxing coloring page.</p>
          ...
          <section className="mb-10">
            ...
            <RelatedArticles
              currentSlug="cozy-coloring-pages"
              type="article"
              count={3}
