...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/blog/community-places-printable-word-search-neighborhood",
});

export default function BlogPost() {
  const title = "Community Places Printable Word Search: Neighborhood Vocabulary for Curious Kids";
  const date = "2026-06-20";
  const blogSchema = {
    "@context": "https://schema.org", "@type": "Article",
    "headline": "Community Places Printable Word Search: Neighborhood Vocabulary for Curious Kids",
    "description": "Explore your neighborhood with community places printable word searches! Town hall, post office, farmers market, fire station — free puzzles that teach kids about the world around them.",
    "url": "https://tinyanimalworlds.com/blog/community-places-printable-word-search-neighborhood",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Community Places Printable Word Search: Neighborhood Vocabulary for Curious Kids", url: "https://tinyanimalworlds.com/blog/community-places-printable-word-search-neighborhood" }
  ]);
  return (<>
    ...
    <article className="page-container py-12 sm:py-16"><div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-cocoa max-w-none">
        <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Explore your neighborhood with community places printable word searches! Town hall, post office, farmers market, fire station — free puzzles that teach kids about the world around them.</p>
        ...
        <p className="text-cocoa/75 leading-relaxed mb-4">Beyond word searches, browse thousands of free printable resources: visit our <Link href="/word-search" className="text-rose hover:underline">Word Search Hub</Link> for 2,000+ puzzles, explore <Link href="/category/cottagecore-coloring" className="text-rose hover:underline">Coloring Pages</Link> for creative fun, and check our <Link href="/blog" className="text-rose hover:underline">Blog</Link> for learning tips and activity ideas.</p>
      ...
      <section className="mb-10"><h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2><RelatedArticles currentSlug="community-places-printable-word-search-neighborhood" type="article" count={3} title="More Articles to Explore" /></section>
      <Newsletter />
      <section className="mt-10 p-6 bg-cream rounded-xl border border-mocha/10"><h2 className="text-xl font-bold text-cocoa mb-2">About This Article</h2><p className="text-sm text-cocoa/50"><strong>Category:</strong> <Link href="/blog" className="text-rose hover:underline">Homeschool Resources</Link> · <strong>Published:</strong> 2026-06-20 · <strong>Read Time:</strong> 7 min read · <strong>Tags:</strong> free printables, word search, kids activities, educational games, coloring pages, homeschool resources, classroom activities, vocabulary building, animal puzzles, printable worksheets</p></section>
