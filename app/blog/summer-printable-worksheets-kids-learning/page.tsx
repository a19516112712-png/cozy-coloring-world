...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/blog/summer-printable-worksheets-kids-learning",
});

export default function BlogPost() {
  const title = "Summer Printable Worksheets: Keep Kids Learning During Break with Free Activities";
  const date = "2026-06-19";
  const blogSchema = {
    "@context": "https://schema.org", "@type": "Article",
    "headline": "Summer Printable Worksheets: Keep Kids Learning During Break with Free Activities",
    "description": "Stop the summer slide! Free printable worksheets featuring word searches, coloring pages, and puzzles that keep young minds engaged all summer long. Perfect for grades K-5.",
    "url": "https://tinyanimalworlds.com/blog/summer-printable-worksheets-kids-learning",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Summer Printable Worksheets: Keep Kids Learning During Break with Free Activities", url: "https://tinyanimalworlds.com/blog/summer-printable-worksheets-kids-learning" }
  ]);
    ...
    <article className="page-container py-12 sm:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Stop the summer slide! Free printable worksheets featuring word searches, coloring pages, and puzzles that keep young minds engaged all summer long. Perfect for grades K-5.</p>
        ...
        <section className="mb-10">
          ...
          <RelatedArticles categoryId="seasonal-coloring" type="coloring" count={6} title="Coloring Pages You Will Love" />
        </section>
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-cocoa mb-6">You May Also Like</h2>
          <RelatedArticles currentSlug="summer-printable-worksheets-kids-learning" type="article" count={3} title="More Articles to Explore" />
        </section>
        <Newsletter />
        <section className="mt-10 p-6 bg-cream rounded-xl border border-mocha/10">
          ...
          <p className="text-sm text-cocoa/50"><strong>Category:</strong> <Link href="/blog" className="text-rose hover:underline">Educational Printables</Link> · <strong>Published:</strong> 2026-06-19 · <strong>Read Time:</strong> 8 min read · <strong>Tags:</strong> free printables, word search, kids activities, educational games, coloring pages, homeschool resources, classroom activities, vocabulary building, animal puzzles, printable worksheets</p>
        </section>
