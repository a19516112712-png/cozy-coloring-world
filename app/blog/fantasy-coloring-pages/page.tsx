...
export const metadata: Metadata = generatePageMetadata({
  imageUrl: "/images/blog-covers/fantasy-coloring-pages.webp",
  imageWidth: 1200,
  imageHeight: 1500,
  ...
  path: "/blog/fantasy-coloring-pages",
});

export default function BlogPost() {
  const title = "Fantasy Coloring Pages: Free Printable Magical and Enchanted Worlds";
...
const blogSchema = {
  ...
  "@type": "Article",
  "headline": "Fantasy Coloring Pages: Free Printable Magical and Enchanted Worlds",
  "description": "Enter magical realms with our fantasy coloring pages! Unicorns, dragons, enchanted forests.",
  "url": "https://tinyanimalworlds.com/blog/fantasy-coloring-pages",
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Fantasy Coloring Pages: Free Printable Magical and Enchanted Worlds", url: "https://tinyanimalworlds.com/blog/fantasy-coloring-pages" }
]);
  return (<>
    <script
    ...
    <article className="page-container py-12 sm:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-cocoa max-w-none">
          <p className="text-lg text-cocoa/70 leading-relaxed mb-6">Enter magical realms with our fantasy coloring pages! Unicorns, dragons, enchanted forests.</p>
          ...
          <section className="mb-10">
            ...
            <RelatedArticles
              currentSlug="fantasy-coloring-pages"
              type="article"
              count={3}
