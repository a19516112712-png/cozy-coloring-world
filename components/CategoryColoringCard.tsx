      ...
      >
        ...
        <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity z-10">
          <button
            onClick={(e) => {
              e.preventDefault();
              const url = `https://www.pinterest.com/pin/create/button/?url=${encodeURIComponent("https://tinyanimalworlds.com/coloring/" + page.slug)}&media=${encodeURIComponent("https://tinyanimalworlds.com" + page.imageUrl)}&description=${encodeURIComponent("Free printable " + page.title + " coloring page. " + page.description)}`;
