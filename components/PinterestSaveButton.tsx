...
export default function PinterestSaveButton({ imageUrl, description }: PinterestSaveButtonProps) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-pill bg-[#e60023] text-white text-sm font-semibold hover:bg-[#cc001f] transition-all shadow-cozy hover:shadow-hover"
    >
